...
Ok, that was bunch of rather abstract information about a concept in
computer science called *substitution*.
...
argument is acceptable or not. In fact there are about 48 different `is_`
functions in the `rlang` package. 
