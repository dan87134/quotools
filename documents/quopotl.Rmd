...
quosures. `rlang::get_expr` is one and it returns the literal text of
of the expresson expresion that was used to make the quosure.
...
Later we'll see that this acts as a path through a list used to represent
a tree of objects.
...
code that parses the text of the expression... in fact that would be very
